...
public class ContactServiceImpl implements ContactService {
    ...
    public List<ContactVO> list(Long userId) {
        ...
        List<ContactsCache> relationCaches = contactCacheService.getContactCache(userId);
        ...
        Map<Long, UserInfoCache> userInfoMap = userInfoCacheService.getUserInfoCacheMapByIds(friendIds);
    ...
    public Long delete(Long id, Long userId) {
        ...
        AfterCommitUtil.executeAfterCommit(() -> {
            // 5.1 删除用户自身的联系人缓存
            contactCacheService.deleteContactCache(userId);
            // 5.2 删除用户会话ZSet缓存
